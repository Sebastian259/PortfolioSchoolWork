    ...
    <section class="home" id="home">
        ...
        <div class="home-content">    
            <div class="home-content-text">
                ...
                <p class="text">
                    "Create content that not only entertains,<br>
                    but also inspires your audience to take action.<br>
                    Infuse your passion into everything you create,<br>
                    and let it shine through in every piece of content.<br>
                    With purpose as your guide, you have the power<br>
                    to make a meaningful impact on the world <br>
    ...
    <section class="intro" id="intro">
        <div class="intro-content">
            <div class="profile-photo">
                <img src="Ja.png" width="410" height="500" style="border-radius: 50px;">
            </div>
            <div class="intro-content-text">
                <h2 class="podnadpis">intro</h2>
                <h1 class="nadpis">about me</h1>
                <p class="text">
                    I am an ambitious student who spends<br>
                    their free time self-educating. Of course,<br>
                    I also enjoy more relaxing activities such as<br>
                    reading books, playing computer games, sports,<br>
                    or trying new things. However, most of my free<br>
                    time is spent at the gym.
                </p>
                <!-- pridať PHP-->
