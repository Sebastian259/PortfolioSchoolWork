...
<body>
    ...
    <div class="work-title">
        ...
        <div class="work-nav">
            ...
            <div><a>photoshoot/edit</a></div>
            <div><a>web designe</a></div>
            <div><a>3D models/prints</a></div>
        </div>
        <div class="work-projects">
            <div class="project web01" id="web"><img src="work/design/design01.png" onclick="window.open(this.src)"></div>
            <div class="project model01" id="models"><img src="work/models/mod01.png" onclick="window.open(this.src)"></div>
            <div class="project photo01" id="photo"><img src="work/photo/photo01.png" onclick="window.open(this.src)"></div>
        </div>
        <div class="work-projects">
            <div class="project model02" id="models"><img src="work/models/mod02.png" onclick="window.open(this.src)"></div>
            <div class="project photo02" id="photo"><img src="work/photo/photo02.png" onclick="window.open(this.src)"></div>
            <div class="project model03" id="models"><img src="work/models/mod03.png" onclick="window.open(this.src)"></div>
        </div>
        <div class="work-projects">
            <div class="project photo03" id="photo"><img src="work/photo/photo03.png" onclick="window.open(this.src)"></div>
            <div class="project model04" id="models"><img src="work/models/mod04.png" onclick="window.open(this.src)"></div>
            <div class="project model05" id="models"><img src="work/models/mod05.jpg" onclick="window.open(this.src)"></div>
        </div>
        <div class="my-game">
                <h1 class="nadpis">PacMan</h1>
                <p>Want to play some game? Try that mine.</p> 
                <a><button class="btn-white podnadpis" href="work/game/pacman.html">play right now</button></a>      
            </div>
    </section>
